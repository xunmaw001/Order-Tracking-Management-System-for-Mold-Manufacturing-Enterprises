...
public class YuangongController {
    ...
    */
    ...
    public R save(@RequestBody YuangongEntity yuangong, HttpServletRequest request){
        ...
        Wrapper<YuangongEntity> queryWrapper = new EntityWrapper<YuangongEntity>()
            ...
            .eq("password", yuangong.getPassword())
            .eq("yuangong_name", yuangong.getYuangongName())
            ...
            .eq("yuangong_bumen", yuangong.getYuangongBumen())
            ;
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yuangong.getId(),username, "yuangong", "用户");
        R r = R.ok();
        r.put("token", token);
        r.put("role","用户");
