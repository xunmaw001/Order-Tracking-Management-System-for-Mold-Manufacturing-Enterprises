                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>部门</label>
                                        <input id="yuangongBumen" name="yuangongBumen" class="form-control"
                                               placeholder="部门">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yuangongPhoto: "照片不能为空",
                yuangongBumen: "部门不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yuangongBumen").val(ruleForm.yuangongBumen);
